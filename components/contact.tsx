                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        <div className="space-y-8">
                            ...
                            <div className="flex gap-4 pt-4">
                                <Link href={"https://github.com/alireza-Ghavabesh"} target="_blank" className="group w-12 h-12 flex items-center justify-center rounded-xl border border-border hover:border-lightBlue/30 hover:bg-hover transition-all">
                                ...
                                <Link href={"https://www.linkedin.com/in/alireza-ghavabesh-0361751a7/"} target="_blank" className="group w-12 h-12 flex items-center justify-center rounded-xl border border-border hover:border-lightBlue/30 hover:bg-hover transition-all">
                                ...
                                <Link href={"https://t.me/alirezaGhavabesh"} target="_blank" className="group w-12 h-12 flex items-center justify-center rounded-xl border border-border hover:border-lightBlue/30 hover:bg-hover transition-all">
